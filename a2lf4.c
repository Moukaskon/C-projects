...
int main(){
    ListPointer Head, BHead, PredPtr;
    ...
    for(i = 0; i < nofelem; i++){
        ...
        scanf("%d%c", &Item, &bin);
        OrderedLinearSearch(Head, Item, &PredPtr, &found);
        LinkedInsert(&Head, Item, PredPtr);
    }
    ...
    for(i = 0; i < nofelem; i++){
        ...
        scanf("%d%c", &Item, &bin);
        OrderedLinearSearch(BHead, Item, &PredPtr, &found);
        LinkedInsert(&BHead, Item, PredPtr);
    }

    printf("1i Lista\n");
    LinkedTraverse(Head);
    printf("\n2i Lista\n");
    LinkedTraverse(BHead);

    MergeLinkedLists(&Head, BHead);
